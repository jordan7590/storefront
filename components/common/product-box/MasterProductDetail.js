      ...
      <div>
        ...
        <h4>
          ...
          {(product.price * currency.value).toFixed(2)}
           ...
           {/* {(product.price_range.min_price * currency.value).toFixed(2)} - {(product.price_range.max_price * currency.value).toFixed(2)} */}
          {/* <del>
        ...
        {/* Check if product.variants is not undefined and is an array before mapping */}
        {product.variants && Array.isArray(product.variants) && product.variants.map((vari) => {
        ...
        product.type === "pets" ? (
          ...
          <>
            {title !== "Product style 4" && uniqueTags.length > 0 && uniqueTags[0].color ? (
